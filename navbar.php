<div id="nav">
    <div class="container">
        <ul id="nav-list" style="margin:0 auto;">	<!--this centers the UL, but not the LI... workarounds?-->
            <li><a href="page.php?page=index&amp;name=Home" id="home" style="margin:50 auto;">Home</a></li>
